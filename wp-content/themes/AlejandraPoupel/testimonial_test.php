<?php
/**
 * Template Name: TestimonialsTest
 *
 * @package WordPress
        ...
        <div class="row">
            ...
            <?php if( have_rows('press_single') ):
                while ( have_rows('press_single') ) : the_row();?>
                    ...
                    <article class="col-xs-6 col-sm-3 pressSingle lightboxSingle"
                        <?php if( have_rows('press_img_list') ):
                            $i = 0;
                            while ( have_rows('press_img_list') ) : the_row();?>
                                <?php

                                echo 'data-image'.$i.'="'.get_sub_field('press_img').'"';
                                $i++;
                                ?>
            ...
            <div class="lightbox">
                <img class ="firstImage" src="" />
                <img class ="secondImage" src="" />
