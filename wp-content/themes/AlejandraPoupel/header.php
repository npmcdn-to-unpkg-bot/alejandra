...
<!--[if gt IE 8]><!--> <html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<div id="preloader">
		...
		<svg version="1.1" id="preloaderLogo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<img class="loader" src="<?php echo get_template_directory_uri(); ?>/library/images/ring.gif" />
	</div>
